  ...
  return (
    <div>
      <section
        ...
        style={{ backgroundImage: 'url("../../dist/images/bg-02.jpg")' }}>
              ...
              <div className="p-r-45 p-r-0-lg">
                ...
                <div className="p-b-63">
                  <a
                    ...
                    <img src="../../dist/images/blog-04.jpg" alt="IMG-BLOG" />
                ...
                <div className="p-b-63">
                  <a
                    href="blog-detail.html"
                    className="hov-img0 how-pos5-parent">
                    <img src="../../dist/images/blog-05.jpg" alt="IMG-BLOG" />
                    <div className="flex-col-c-m size-123 bg9 how-pos5">
                ...
                <div className="p-b-63">
                  <a
                    href="blog-detail.html"
                    className="hov-img0 how-pos5-parent">
                    <img src="../../dist/images/blog-06.jpg" alt="IMG-BLOG" />
                    <div className="flex-col-c-m size-123 bg9 how-pos5">
